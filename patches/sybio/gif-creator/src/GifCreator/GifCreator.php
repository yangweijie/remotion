 ...
 * 
 * PHP 8.0+ Compatible Version (Patched)
 * 
 * @version 1.0
...
class GifCreator
{
    ...
    public function create($frames = array(), $durations = array(), $loop = 0)
    {
        ...
        for ($i = 0; $i < count($frames); $i++) {
            ...
            // PHP 8.0+ Fix: Check for GdImage object instead of resource
            $isGdImage = (is_resource($frames[$i]) || (is_object($frames[$i]) && $frames[$i] instanceof \GdImage));
            
            if ($isGdImage) { // Resource var or GdImage object (PHP 8.0+)
            ...
            // PHP 8.0+ Fix: Use array syntax instead of deprecated string offset syntax
            ...
            // PHP 8.0+ Fix: Use array syntax [] instead of deprecated {}
